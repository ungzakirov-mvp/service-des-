...
from app.models import Tenant  # noqa - needed for relationship resolution

db = SessionLocal()
db.query(TariffFeature).delete()
db.query(ServiceCatalog).delete()
from app.models_tariffs import OrgSubscription, ServiceRequestItem, ServiceRequest
db.query(ServiceRequestItem).delete(synchronize_session=False)
db.query(ServiceRequest).delete(synchronize_session=False)
db.query(OrgSubscription).delete(synchronize_session=False)
db.query(TariffFeature).delete(synchronize_session=False)
db.query(TariffPlan).delete(synchronize_session=False)
db.query(ServiceCatalog).delete(synchronize_session=False)
...
services = [
    ServiceCatalog(
        ...
        price=9900000, price_unit_ru="\u043c\u0435\u0441/\u0448\u0442", price_unit_en="mo/unit", price_unit_uz="oy/birlik",
    ...
    ServiceCatalog(
        ...
        price=24900000, price_unit_ru="\u043c\u0435\u0441/\u0448\u0442", price_unit_en="mo/unit", price_unit_uz="oy/birlik",
    ...
    ServiceCatalog(
        ...
        price=19000000, price_unit_ru="\u043c\u0435\u0441", price_unit_en="mo", price_unit_uz="oy",
    ...
    ServiceCatalog(
        ...
        price=14900000, price_unit_ru="\u043c\u0435\u0441", price_unit_en="mo", price_unit_uz="oy",
        price_type="monthly", is_quantifiable=False, min_quantity=1, max_quantity=1,
    ...
    ServiceCatalog(
        ...
        price=9900000, price_unit_ru="\u043c\u0435\u0441", price_unit_en="mo", price_unit_uz="oy",
        price_type="monthly", is_quantifiable=False, min_quantity=1, max_quantity=1,
    ...
    ServiceCatalog(
        ...
        price=4900000, price_unit_ru="\u043c\u0435\u0441/\u043b\u0438\u0446\u0435\u043d\u0437\u0438\u044f", price_unit_en="mo/license", price_unit_uz="oy/litsenziya",
        price_type="monthly", is_quantifiable=True, min_quantity=1, max_quantity=500,
    ...
    ServiceCatalog(
        ...
        price=29000000, price_unit_ru="\u0432\u044b\u0437\u043e\u0432", price_unit_en="call", price_unit_uz="chaqiriq",
    ...
    ServiceCatalog(
        ...
        price=99000000, price_unit_ru="\u0430\u0443\u0434\u0438\u0442", price_unit_en="audit", price_unit_uz="audit",
